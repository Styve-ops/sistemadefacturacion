...
$nombreDelArchivo = date(format:"Y-m-d-h-i-s");
...
move_uploaded_file($_FILES['image']['tmp_name'],$location);
    ...
    $sentencia = $pdo->prepare("INSERT INTO tb_almacen 
       (codigo,id_categoria,nombre,id_usuario,descripcion,stock,stock_minimo,stock_maximo,precio_compra,precio_venta,fecha_ingreso,imagen,fyh_creacion  ) 
