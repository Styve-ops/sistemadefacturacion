...
<div class="content-wrapper">
                         ...
                         <div class="col-md-12">
                                    <div class="card card-primary">
                                            <div class="card-header">
                                                ...
                                                <input type="text" value="<?php echo $contador_de_ventas + 1; ?>" disabled></h3>
         ...
         <div class="modal fade" id="modal-buscar_producto">
            ...
            <div class="table table-responsive">
                  ...
                  <?php
                            ...
                            <button class="btn btn-primary" id="btn_registrar_carrito" style="float: right;">Guardar</button>
 ...
 <br><br>
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" 
                 ...
                 <!-- modal para visualar datos de los clientes -->
            ...
            <input type="text" class="form-control" id="email_cliente">
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="total_pagado" class="form-control" style="text-align: center;">
                                                    <script>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                 <label for="">Cambio</label>
                                                   <input type="text" id="cambio" class="form-control" style="text-align: center;"  disabled>
                                               </div>
                                             </div>
                                    ...
                                    <hr>
                                             <div class="form-group">
                                                <button id="btn_gruardar_venta" class="btn btn-primary btn-block">Guardar venta</button>
                                                <div id="respuesta_registro_venta"></div>
                                                <script>
                                                        $('#btn_gruardar_venta').click(function (){
                                                            var nro_venta = '<?php echo $contador_de_ventas + 1; ?>';
