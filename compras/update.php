                        ...
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nombre" id="nombre_producto" value="<?= $nombre_producto; ?>" class="form-control" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?= $nombres_usuario; ?>" id="usuario_producto" disabled>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="<?= $stock; ?>" name="stock" id="stock" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                                ...
                                <div class="form-group">
                                        ...
                                        <input type="text" value="<?= $stock=$stock-$cantidad; ?>" id="stock_actual" style="text-align: center;" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
                                ...
                                <script>
                                    $('#btn_actualizar_compra').click(function (){
                                            ...
                                            if(id_producto == "" ) {
                                                ...
                                                $('#fecha_compra').focus();
                                                alert("Debe llenar todos los campos fecha");
                                            }else if(comprobante == "" ) {
                                                $('#comprobante').focus();
                                                alert("Debe llenar todos los campos comprobnte");
                                                ...
                                                alert("Debe llenar todos los campos cantidad compra");
                                            } else {
