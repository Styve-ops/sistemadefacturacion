            ...
            <div class="card card-danger">
              ...
              <div class="card-body" style="display: block;">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="stock" value="<?= $stock; ?>" id="stock" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="">Stock minimo:</label>
                                        <input type="number" name="stock_minimo" value="<?= $stock_minimo; ?>" id="stock_minimo" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="">Stock maximo:</label>
                                        <input type="number" name="stock_maximo" value="<?= $stock_maximo; ?>" id="stock_maximo" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="">Precio compra:</label>
                                        <input type="number" name="precio_compra" value="<?= $precio_compra_producto; ?>" id="precio_compra" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="">Precio venta:</label>
                                        <input type="number" name="precio_venta" value="<?= $precio_venta_producto; ?>" id="precio_venta" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="">Fecha ingreso:</label>
                                        <input type="date" name="fecha_ingreso" value="<?= $fecha_ingreso; ?>" id="fecha_ingreso" class="form-control" disabled>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                    <div class="form-group">
                                    <input type="text" id="id_proveedorr" hidden>
                                    <label for="">Nombre del proveedor </label>
                                    <input type="text" id="nombre_proveedorr" value="<?= $nombre_proveedor_tabla; ?>" class="form-control" disabled>
                    ...
                    <div class="form-group">
                                    ...
                                    <input type="number" id="celular" value="<?= $celular_proveedor; ?>" class="form-control" disabled>
                    ...
                    <div class="form-group">
                                    ...
                                    <input type="number" id="telefono" value="<?= $telefono_proveedor; ?>" class="form-control" disabled>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                                    ...
                                    <input type="email" id="email" value="<?= $email_proveedor; ?>" class="form-control" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                <div class="form-group">
                                        <label for="">Comprobrante de la compra</label>
                                ...
                                <div class="col-md-12">
                                <div class="form-group">
                                        <label for="">Cantida de la compra</label>
